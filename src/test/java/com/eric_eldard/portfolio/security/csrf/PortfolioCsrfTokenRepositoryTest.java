...
public class PortfolioCsrfTokenRepositoryTest
{
    ...
    public void setUp()
    {
        csrfTokenRepo = new PortfolioCsrfTokenRepository(60, securityContextService);
        spyOnTokenCache();
    }
    ...
    {
        when(securityContextService.getCurrentUsersIdNullable()).thenReturn(USER_ID);
        csrfTokenRepo = new PortfolioCsrfTokenRepository(1, securityContextService);
        spyOnTokenCache();
