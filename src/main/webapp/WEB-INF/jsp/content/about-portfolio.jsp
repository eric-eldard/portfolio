...
<p>
    ...
    players to prevent simultaneous play, pre-compiled JSPs for faster load times, and an admin-only UI sitting atop a
    robust RESTful user management suite. I'm constantly adding and upgrading, and it's been a blast to work on!
</p>
