...
<p>
    ...
    features a mobile-friendly UI created from scratch, pre-compiled JSPs for faster load times, recursive asset
    preloading, third-party video integration, JWT auth tokens, and robust admin-only user management. I'm constantly
    adding and upgrading, and it's been a blast to work on!
</p>
