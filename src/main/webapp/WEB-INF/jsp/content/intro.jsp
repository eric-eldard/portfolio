...
<div class="intro-text">
    <p>
        ...
        I used programming skills to maximize the time and effectiveness of myself and my team. I believe in automating
        the mundane, delivering high value quickly&mdash;then iterating, and building things that are extensible and
        easily maintained.
    </p>
    <p>
        I joined the startup
        <jsp:include page="../widgets/link-out.jsp">
            <jsp:param name="text" value="Brazen"/>
        ...
        </jsp:include>, I'd been Brazen's Vice President of Engineering for 2 years. I stayed on into mid-2024 to help
        ensure a successful transition into our new parent company, leading all of Brazen's IT personnel after the exit
        of our CTO in January of that year.
    </p>
    <p>
